...
from scripts import train_util, model_util
import numpy as np
...
def resize(save_precision=None, new_rank=4, model=None, save_to=None, device=None, dynamic_method=None, dynamic_param=None, verbose=False):
  ...
  if dynamic_method and not dynamic_param:
  ...
  print("resizing rank...")
  state_dict, old_dim, new_alpha = resize_lora_model(lora_sd, new_rank, save_dtype, device, dynamic_method, dynamic_param, verbose)
...
if __name__ == '__main__':
  ...
  resize(args.save_precision, args.new_rank, args.model, args.save_to, args.device, args.dynamic_method, args.dynamic_param, args.verbose)
